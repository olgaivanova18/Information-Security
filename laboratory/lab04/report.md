...
![права доступа](images/01.png){ #fig:001 width=70% height=70%}
...
![атрибут -a](images/02.png){ #fig:002 width=70% height=70%}
...
![атрибут -a снят](images/03.png){ #fig:003 width=70% height=70%}
...
![атрибут -i](images/04.png){ #fig:004 width=70% height=70%}
