...
![Добавление пользователей в группу](images/01.png){ #fig:001 width=70% }
...
![Информация о пользователях](images/02.png){ #fig:002 width=70% }
...
![Содержимое файла /etc/group и регистрация в группе](images/03.png){ #fig:003 width=70% }
...
![Изменение прав у директории](images/04.png){ #fig:004 width=70% }
