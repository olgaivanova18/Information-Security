...
![подготовка к работе](images/01.png){ #fig:001 width=70% height=70%}
...
![программа simpleid](images/02.png){ #fig:002 width=70% height=70%}
...
![результат программы simpleid](images/03.png){ #fig:003 width=70% height=70%}

6.	Усложнили программу, добавив вывод действительных идентификаторов.

![программа simpleid2](images/04.png){ #fig:004 width=70% height=70%}
...
![результат программы simpleid2](images/05.png){ #fig:005 width=70% height=70%}

13.	Написали программу readfile.c

![программа readfile](images/06.png){ #fig:006 width=70% height=70%}
...
![результат программы readfile](images/07.png){ #fig:007 width=70% height=70%}
...
![исследование Sticky-бита](images/08.png){ #fig:008 width=70% height=70%}
